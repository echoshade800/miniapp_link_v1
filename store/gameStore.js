...
export const GameUtils = {
  ...
  // Get level kinds (increases +1 every 6 levels, max 20)
  getLevelKinds: (level) => {
    if (level <= 6) {
      return 5; // 1-6关：5种牌
    } else if (level <= 12) {
      ...
      // 13关起：15种，每6关+1种，最多20种
      // 13-18关: 15, 19-24关: 16, 25-30关: 17, 31-36关: 18, 37-42关: 19, 43关+: 20
      return Math.min(20, 15 + Math.floor((level - 13) / 6));
    }
  },
